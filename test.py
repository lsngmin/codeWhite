...
if __name__ == "__main__":
    test_db_path = p.get_p("datasets") + "/test"
    ...
    model_filename = p.get_p("/home/codewhite/ultralytics/started/trainModels/tld_detections_1021/weights/best.pt")
